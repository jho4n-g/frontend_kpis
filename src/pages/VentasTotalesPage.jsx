...
import {
  ...
  ObtenerPeriodo,
  UpdateObje,
} from '../service/ventaTotal.js';
import IngresoVentaModal from '../components/VentaTotal/VentaTotalModal.jsx';
import VentasTotalesECharts from '../components/graficos/VentasTotales/VentasTotalesEcharts.jsx';
import CumplimientoChart from '../components/graficos/VentasTotales/CumplimientosECharts.jsx';
...
const columns = [
  ...
  {
    id: 'DifVentaMenvsPreMen',
    label: 'Diferencia entre Venta Mensual vs Presupuesto Mensual',
    minWidth: 140,
    align: 'right',
    format: formatNumber,
  },
  {
    id: 'DiffVentaAcuvsPresAcu',
    label: 'Diferencia entre Venta Acumulada vs Presupuesto Acumulado',
    minWidth: 130,
    align: 'right',
    format: formatNumber,
  },
  ...
  return (
    <Paper sx={{ width: '100%', overflow: 'hidden', position: 'relative' }}>
      <Stack spacing={3}>
        ...
        <Paper>
          <VentasTotalesECharts rows={valorsTabla} />
        </Paper>
        <Paper>
          <CumplimientoChart rows={valoresCump} />
        </Paper>
      </Stack>
    </Paper>
  );
